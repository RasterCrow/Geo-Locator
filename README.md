...
## You can play it [here](https://geolocator.alexcrow.dev/)
...
You can now play it without hosting it [here](https://geolocator.alexcrow.dev/). If you need some help visit the [Wiki](https://github.com/RasterCrow/Geo-Locator/wiki).
